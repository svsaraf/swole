...
AUTH_PROFILE_MODULE = 'ideas.userprofile'
...
SECRET_KEY = '@vk)=7homsbuiw0fmg^wo5_90-hpf%bv3kh^=9brt+dq8=39@5'
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    os.path.join(os.path.dirname(__file__), 'ideas/templates').replace('\\','/'),
)
